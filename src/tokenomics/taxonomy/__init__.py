...
def load_catalog(catalog_dir: Path | None = None) -> Catalog:
    """Load and validate every ``*.toml`` pattern file. Stable order by id."""
    d = catalog_dir or _CATALOG_DIR
...
__all__ = ["Catalog", "Pattern", "RuleError", "CATEGORY_ANALYSIS", "load_catalog"]
